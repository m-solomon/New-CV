...
\tagline{Master Student in Computational Engineering}

%\includegraphics{Mohamed Soliman}
%\photo{2.8cm}{Globe_High}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{m.monem1259@gmail.com}
  \phone{+49-163 2181 308}
  %\mailaddress{Haagstr. 17, Erlangen, 91054}
...
\cvevent{BMS Engineer}{Saudi Binladin Group}
...
\cvevent{Autonomous UAV (Ongoing)}{Development of a Fully Automated UAV Security System}
...
\clearpage
\cvsection[page2sidebar]{Relevant Experience}

\cvevent{Program Coordinator}{IEEE KFUPM Student Branch}{Sept. 2016 -- Present}{Dhahran, KSA}
\begin{itemize}
...
\cvevent{Professional Photographer}{Freelancer}{Oct. 2016 -- Present}{Dhahran, KSA}
\begin{itemize}
